...
describe('User', function() {
  ...
  describe('#getUser()', function() {
    it('should find a user if it exists', function(done) {
      Users.getUser(mockUsername, function(user) {
        assert.ok(user);
        done();
      });
    });
  ...
  describe('#isUser()', function() {
    it('should verify a user credential set', function(done) {
      Users.isUser(mockUsername, mockPassword, function(err, result) {
        assert.ok(result);
        done();
      });
    });
